      ...
      <View style={styles.arrows} pointerEvents="box-none">
        <View style={[styles.arrowsContainer, this.props.arrowsContainerStyle]} pointerEvents="box-none">
          ...
          >
            <Icon
              type={'ionicon'}
              name={this.props.leftArrowText ? this.props.leftArrowText : 'ios-arrow-back'}
              size={30}
              color={(this.state.currentPage === 0) ? '#a6a6a6' : '#fff'}
              style={{padding: 10}}
            />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={
              () => {
                if (this.state.currentPage !== childrenLength - 1) {
                  this.animateToPage(this._normalizePageNumber(currentPage + 1));
                }
              }}
            style={this.props.arrowstyle}
          >
            <Icon
              type={'ionicon'}
              name={this.props.rightArrowText ? this.props.rightArrowText : 'ios-arrow-forward'}
              size={30}
              color={(this.state.currentPage === childrenLength - 1) ? '#a6a6a6' : '#fff'}
              style={{padding: 10}}
            />
          </TouchableOpacity>
        </View>
